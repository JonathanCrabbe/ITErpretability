    ...
    def run(
        ...
        for shift in range(9):
            ...
            for propensity_type in ["prog"]:
                ...
                ipwlearner = cate_models.torch.IPWNet(
                        X_train.shape[1],
                        binary_y=(len(np.unique(Y_train)) == 2),
                        n_layers_r=1,
                        n_layers_out=1,
                ...
                ipwlearner.fit(X=X_train, y=Y_train, w=W_train)
                ...
                print('-'*89)
                print(cepehe, cfrpehe, tarpehe, ipwpehe)
                print('-' * 89)
                with open("test.txt", "a") as myfile:
                    if shift == 0:
                        myfile.write("seed: " + str(self.seed) + "\n")
                    myfile.write(propensity_type + " ce" + str(cepehe) + "cfr" + str(cfrpehe) + "ipw" + str(ipwpehe) + "tar" + str(tarpehe) + "\n")